...
import getCont from '@salesforce/apex/contactsSearchController.getContacts';
import getAppSlot from '@salesforce/apex/appointmentSlotController.getAppointmentSlots';
...
export default class AppointmentForm extends LightningElement {
    ...
    @wire(getCont, { searchTerm: '$searchTerm' })
    ...
    handleDateTimeChange(event) {
        ...
        this.time = dt.toISOString().split('T')[1].split('.')[0]; 
